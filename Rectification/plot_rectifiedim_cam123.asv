...
[cam1_name,cam1_path] = uigetfile('Select camera 1 rectified image');
[cam2_name,cam2_path] = uigetfile('Select camera 2 rectified image');
[cam3_name,cam3_path] = uigetfile('Select camera 3 rectified image');
cam1 = load([cam1_path,cam1_name]);
cam2 = load([cam2_path,cam2_name]);
cam3 = load([cam3_path,cam3_name]);
