...
switch input_answer
    ...
    case 'No - Create Now'
        ...
        for cc = 1:2 %BL: two cameras' calibration 
            ...
            [temp_file, temp_file_path] = uigetfile(global_dir, 'Camera Frame with GCP');
        ...
        save(fullfile(temp_file_path, [info{1} '.mat']), 'R', 'origin_grid')
...
for cc = 1:2
    ...
    for pp = 1 : length(Products)
        ...
        save(fullfile(data_dir, 'Processed_data', strcat(oname, '_Products')),'Products', '-v7.3')
        toc
